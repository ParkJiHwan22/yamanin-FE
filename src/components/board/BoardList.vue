<template>
    <div>
        <div class="flex justify-between p-10">
            ...
            <button @click="navigateToCreate" class="color-pink-bg text-white px-4 py-2 me-5 rounded-xl hover:bg-pink-500 transition duration-300 ease-in-out text-xl">글 작성하기</button>
        </div>
        ...
        <div class="bg-white mx-10 mb-20 rounded-lg pt-5 shadow-lg">
            ...
            <div v-for="board in store.boardList" :key="board.id" @click="navigateToDetail(board.postId)" class="cursor-pointer hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-1">
                <div class="grid grid-cols-3 gap-2 p-2 m-5 rounded-lg border-2 shadow-md">
